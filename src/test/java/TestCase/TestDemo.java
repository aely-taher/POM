...
public class TestDemo extends BaseTest {
    ...
    public void register() {
        ...
        registerForm.fName().sendKeys("Komu");
        registerForm.lName().sendKeys("Taher");
        registerForm.email().sendKeys("komutahermvn83@gmail.com");
        registerForm.telephone().sendKeys("1234567890");
        registerForm.password().sendKeys("komu123");
        registerForm.confirmPassword().sendKeys("komu123");
